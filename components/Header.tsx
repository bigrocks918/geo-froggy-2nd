...
const Header = () => {
  ...
  return (
    <header className="relative bg-white shadow-[0_4px_4px_0_rgba(0,0,0,0.05)] z-10 flex justify-center">
      <div className="container">
        <nav className="flex justify-between h-[76px]">
          ...
          <div
            className={`navLinks duration-500 absolute md:static md:w-auto w-full md:h-auto h-[100vh] bg-white flex md:items-center top-[100%] left-[-100%] ${
              open ? 'left-[0%]' : ''
            }`}
          >
