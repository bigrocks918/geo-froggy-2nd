...
const Header = () => {
  ...
  const onMenuToggle = () => {
    setOpen(open === 'menu' ? 'close' : 'menu');
  };

  return (
    <header className="relative bg-white shadow-[0_4px_4px_0_rgba(0,0,0,0.05)] z-10">
      <nav className="flex justify-between h-[76px]">
        <div className="flex items-center">
          <Image
            ...
            height={66}
            width={186}
            className="px-6 lg:grid-cols-6 md:grid-cols-2 sm:mt-0"
          />
          <span className="cursor-pointer md:hidden" onClick={onMenuToggle}>
            <svg
        ...
        <div
          className={`navLinks duration-500 absolute md:static md:w-auto w-full md:h-auto h-[60vh] bg-white flex md:items-center gap-[1.5vw] top-[100%] left-[-100%] px-5 md:py-0 py-5 ${
            open === 'menu' ? 'left-[0%]' : ''
          }`}
        >
          <ul className="flex md:flex-row flex-col md:items-center md:gap-[2vw]">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <div className="auth flex items-center w-full sm:mr-10">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              <span className="text-xl ml-[50px]">Kyle Keenan</span>
